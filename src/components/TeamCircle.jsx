...
//           <div
//             className="w-full h-auto min-h-[10rem] rounded-md bg-cover bg-center relative"
//             style={{ backgroundImage: `url(${bgImage})` }}
//           >
//             <div
//               className="group absolute top-[-2rem] left-[10%] sm:left-[15%] xl:left-[38%] flex flex-col items-center"
//               onMouseEnter={() => setHoveredProfile("islam")}
//               onMouseLeave={() => setHoveredProfile(null)}
//             >
//               <img
//                 src={teammember1img}
//                 alt="إسلام شاكر، المؤسس المشارك"
//                 className="w-1/3 max-w-[8rem] h-auto object-cover transition-transform duration-500 group-hover:scale-110"
//               />
//               <div className="flex flex-col mt-4 transition-transform duration-500 group-hover:-translate-y-6">
//                 <h2 className="bg-orange-900 px-4 py-1 text-center text-white -rotate-3 text-sm sm:text-base font-bold">
//                   إسلام شاكر
//                 </h2>
//                 <span className="bg-white px-3 py-1 text-center text-xs sm:text-sm rotate-4 font-bold">
//                   Co-founder & CCO
//                 </span>
//               </div>
//               <AnimatePresence>
//                 {hoveredProfile === "islam" && (
//                   <motion.div
//                     className="absolute z-10 flex flex-col gap-2 top-[8rem] sm:top-[10rem] right-0 bg-gray-900/80 text-white p-4 rounded-lg w-full max-w-[16rem] text-xs sm:text-sm"
//                     variants={infoVariants}
//                     initial="initial"
//                     animate="animate"
//                     exit="exit"
...
//             </div>
//             <div
//               className="group absolute top-[-2rem] right-[10%] sm:right-[15%] xl:right-[36%] flex flex-col items-center"
//               onMouseEnter={() => setHoveredProfile("abdullah")}
//               onMouseLeave={() => setHoveredProfile(null)}
//             >
//               <img
...
//               />
//               <div className="flex flex-col mt-4 transition-transform duration-500 group-hover:-translate-y-6">
//                 <h2 className="bg-orange-900/90 px-4 py-1 text-center text-white rotate-1 text-sm sm:text-base font-bold">
//                   عبدالله عسيري
//                 </h2>
//                 <span className="bg-white px-3 py-1 text-center text-xs sm:text-sm -rotate-3 font-bold">
//                   Co-founder & CCO
//                 </span>
//               </div>
//               <AnimatePresence>
//                 {hoveredProfile === "abdullah" && (
//                   <motion.div
//                     className="absolute z-10 flex flex-col gap-2 top-[8rem] sm:top-[10rem] right-0 bg-gray-900/90 text-white p-4 rounded-lg w-full max-w-[16rem] text-xs sm:text-sm"
//                     variants={infoVariants}
//                     initial="initial"
//                     animate="animate"
//                     exit="exit"
...
//           </div>
//         </div>
//         <div className="w-full xl:basis-[20%] flex flex-col justify-start items-start">
//           <TeamLeftContentTop />
//         </div>
//       </div>
...
//       <div className="flex flex-col xl:flex-row gap-4 w-full">
//         <div className="flex-1 w-full flex justify-center items-center">
//           <div className="w-full max-w-3xl h-auto rounded-xl flex justify-center items-center relative">
//             <Swiper
//               modules={[Navigation, Pagination]}
//               spaceBetween={10}
//               breakpoints={{
...
//                 prevEl: ".custom-prev",
//               }}
//               className="w-full rounded-xl bg-gradient-to-r from-gray-900 to-transparent"
//             >
//               {teamMembers.map((member, index) => (
//                 <SwiperSlide key={index} className="flex justify-center">
//                   <TeamMemberCard
...
//               ))}
//             </Swiper>
//             <button className="custom-prev absolute left-2 top-1/2 -translate-y-1/2 bg-gray-700/80 text-white rounded-full w-7 h-7 flex items-center justify-center hover:bg-gray-700 transition-colors z-10">
//               <BiSkipPrevious />
//             </button>
//             <button className="custom-next absolute right-2 top-1/2 -translate-y-1/2 bg-gray-700/80 text-white rounded-full w-7 h-7 flex items-center justify-center hover:bg-gray-700 transition-colors z-10">
//               <MdSkipNext />
//             </button>
//           </div>
//         </div>
  ...
  return (
    ...
    >
      <div className="flex flex-col xl:flex-row justify-center items-center gap-6 w-full">
        ...
        <div className="flex-1 w-full flex justify-center items-center">
          <div
            className="w-full max-w-2xl h-auto min-h-[15rem] rounded-lg bg-cover bg-center relative"
            style={{ backgroundImage: `url(${bgImage})` }}
          >
            <div
              className="group absolute top-[-2rem] left-[10%] sm:left-[15%] xl:left-[38%] flex flex-col items-center"
            ...
            >
              <img
                src={teammember1img}
                alt="إسلام شاكر، المؤسس المشارك"
                className="w-full max-w-[10rem] h-auto object-cover rounded-full transition-transform duration-500 group-hover:scale-110"
              />
              <div className="flex flex-col mt-4 transition-transform duration-500 group-hover:-translate-y-6">
                <h2 className="bg-orange-900 px-4 py-1 text-center text-white -rotate-3 text-sm sm:text-base font-bold">
                  إسلام شاكر
              ...
              <AnimatePresence>
                {hoveredProfile === "islam" && (
                  <motion.div
                    className="absolute z-10 flex flex-col gap-2 top-[10rem] sm:top-[12rem] right-0 bg-gray-900/80 text-white p-4 rounded-lg w-full max-w-[18rem] text-xs sm:text-sm"
                    variants={infoVariants}
                    initial="initial"
                    animate="animate"
                    exit="exit"
                  >
                    <span>
                      يقود العمليات ويشرف على تنفيذ المشاريع من الفكرة حتى
                      التسليم زبخبرة تجمع بين الاخراج والابداع والادارة
                    </span>
                    <span>
                      يحرص ان كل شىء يطلع من ريب يحمل الزبدة بوضوح وباعلى جودة
                    </span>
                    <span>e.shaker@reprofilm.com</span>
                    <span>+966 532 6423 75</span>
                  </motion.div>
            ...
            >
              ...
              <AnimatePresence>
                {hoveredProfile === "abdullah" && (
                  <motion.div
                    className="absolute z-10 flex flex-col gap-2 top-[10rem] sm:top-[12rem] right-0 bg-gray-900/90 text-white p-4 rounded-lg w-full max-w-[18rem] text-xs sm:text-sm"
                    variants={infoVariants}
                    initial="initial"
                    animate="animate"
                    exit="exit"
                  >
                    <span>
                      يركّز على تطوير العلاقات الاستراتيجية، واستكشاف الفرص،
                      ومتابعة رضا العملاء.
                    </span>
                    <span>
                      يفهم السوق، ويقود نمو ريب بثقة، يحرص إن الشراكة ما تنتهي
                      عند التسليم، بل تبدأ من عنده.
                    </span>
                    <span>a.assiri@reprofilm.com</span>
                    <span>+966 501 8024 94</span>
                  </motion.div>
      ...
      <div className="flex flex-col xl:flex-row gap-6 w-full">
        ...
        <div className="flex-1 w-full flex justify-center items-center border border-gray-800 rounded-xl">
          <div className="w-full max-w-2xl h-auto rounded-lg flex justify-center items-center relative">
            <Swiper
              modules={[Navigation, Pagination]}
              spaceBetween={10}
              breakpoints={{
              ...
              className="w-full rounded-lg bg-gradient-to-r from-gray-900 to-transparent"
            >
              {teamMembers.map((member, index) => (
                <SwiperSlide key={index} className="flex justify-center">
                  <TeamMemberCard
            ...
            <button className="custom-prev absolute left-2 top-1/2 -translate-y-1/2 bg-gray-700/80 text-white rounded-full w-8 h-8 flex items-center justify-center hover:bg-gray-700 transition-colors z-10">
              <BiSkipPrevious />
            </button>
            <button className="custom-next absolute right-2 top-1/2 -translate-y-1/2 bg-gray-700/80 text-white rounded-full w-8 h-8 flex items-center justify-center hover:bg-gray-700 transition-colors z-10">
              <MdSkipNext />
            </button>
          </div>
        </div>
