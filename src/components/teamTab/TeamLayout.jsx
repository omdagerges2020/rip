  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col xl:flex-row justify-center items-center gap-4 w-full">
        {/* <div className="w-full md:w-[220px] flex-shrink-0 flex justify-center items-center">
          <TeamLeftContentTop />
        </div> */}
        {/* Co-founders section */}
        <div className="flex-1">
          ...
          >
            <img
              src={teammember1img}
              alt="إسلام شاكر"
              className="w-[220px] h-[120px] top-[-40px] left-[30px] absolute"
            />
            <img
              src={teammember2img}
              alt="عبدالله عسيري"
              className="w-[220px] h-[120px] top-[-40px] left-[180px] absolute"
            />
            <div className="flex flex-col absolute bottom-[5px] left-[160px]">
              <h2 className="bg-orange-900/70 px-7 text-center w-fit text-white -rotate-3 transition-transform duration-500">
                إسلام شاكر
          ...
          {/* TeamLeftContentTop */}
        <div className="w-full xl:w-[220px] flex-shrink-0 flex flex-col justify-start">
          <TeamLeftContentTop />
        </div>
      </div>
      ...
      <div className="flex flex-col xl:flex-row gap-4 w-full">
        {/* <div className="w-full md:w-[220px] flex-shrink-0 flex flex-col justify-start">
          <TeamLeftContentBottom />
        </div> */}
        {/* السلايدر */}
        <div className="flex-1">
          <div className="w-full max-w-2xl h-[150px] rounded-xl border-[1px] border-gray-800 flex justify-center items-center relative">
            <Swiper
              modules={[Navigation, Pagination]}
              spaceBetween={20}
              slidesPerView={6}
            ...
            <button className="custom-prev border-[1px] absolute left-2 top-1/2 -translate-y-1/2 bg-gray-700/80 text-white rounded-full w-7 h-7 flex items-center justify-center hover:bg-gray-700 transition-colors z-10">
              <BiSkipPrevious />
            </button>
            <button className="custom-next border-[1px] absolute right-2 top-1/2 -translate-y-1/2 bg-gray-700/80 text-white rounded-full w-7 h-7 flex items-center justify-center hover:bg-gray-700 transition-colors z-10">
              <MdSkipNext />
            </button>
          </div>
        </div>
